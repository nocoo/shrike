...
Human overview: [README.md](README.md). Direction: [architecture](docs/02-architecture.md). Frameworks must preserve this handbook. Maintain this root `AGENTS.md` as the only project handbook; do not create a `CLAUDE.md` alias, copy or import.
...
| L1 static (former G1, TS / Rust) | planned | Hook/CI run TS checks, zero-warning ESLint and clippy; Prettier check exists but is not part of those gates. |
